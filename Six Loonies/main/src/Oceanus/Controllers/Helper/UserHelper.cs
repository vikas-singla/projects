...
namespace Oceanus.Controllers
{
    public static class UserHelper
    {
        ...
        internal static void RemoveUserProfileImageUrlCookie()
        {
            if (System.Web.HttpContext.Current.Request.Cookies[CookieDefinitions.COOKIE_USER_PROFILE_IMG_KEY] != null)
            {
                System.Web.HttpContext.Current.Response.Cookies.Remove(CookieDefinitions.COOKIE_USER_PROFILE_IMG_KEY);
            }
        }
        ...
        internal static void RemoveUserProfileId()
        {
            if (System.Web.HttpContext.Current.Request.Cookies[CookieDefinitions.COOKIE_USER_ID] != null)
            {
                System.Web.HttpContext.Current.Response.Cookies.Remove(CookieDefinitions.COOKIE_USER_ID);
            }
        }
        ...
        internal static void RemoveUserProfileFullName()
        {
            if (System.Web.HttpContext.Current.Request.Cookies[CookieDefinitions.COOKIE_USER_PROFILE_FULLNAME_KEY] != null)
            {
                System.Web.HttpContext.Current.Response.Cookies.Remove(CookieDefinitions.COOKIE_USER_PROFILE_FULLNAME_KEY);
            }
        }
