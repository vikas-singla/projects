...
(function ($) {
    ...
    $.TokenList = function (input, url_or_data, settings) {
        ...
        .addClass(settings.classes.emptyTextStyle)
        .val(settings.emptyText)
        .focus(function () {
            ...
            if ($(this).val() === settings.emptyText) {
                $(this).removeClass(settings.classes.emptyTextStyle);
                $(this).val("");
            }
        })
        .blur(function () {
            ...
            if ($.trim(input_box.val()) != "" && $.trim(input_box.val()) != settings.emptyText) {
                var newObj = new Object();
                newObj.id = "-1";
                newObj.fbuid = "-1";
                newObj.name = input_box.val();
                newObj.email = input_box.val();
                newObj.userprofileimageurl = "";
            ...
            $(this).val("");
            if (token_count <= 0) {
                $(this).addClass(settings.classes.emptyTextStyle);
        ...
        function add_token(item) {
            ...
            if (token_count > 0 && settings.preventDuplicates) {
                ...
                token_list.children().each(function () {
                    ...
                    if (existing_data && ((existing_data.id != -1 && item.id != -1 && existing_data.id === item.id) || (existing_data.name === item.name))) {
        ...
        function run_search(query) {
            ...
            if (cached_results) {
                ...
                if (settings.url) {
                    ...
                    ajax_params.error = function (xhr, ajaxOptions, thrownError) {
                        hide_dropdown();
                    };
