...
var oceanus = {
    ...
    **/
    regexps: {
        ...
        postRe: /(\bpost\b)|(\bpost-([1234567890]{1,})\b)|(\bcnnPostWrap\b)|(\bpostbox\b)/i,
        trimRe: /^\s+|\s+$/g,
        normalizeRe: /\s{2,}/g,
    ...
    **/
    prepArticle: function (articleContent) {
        ...
        oceanus.clean(articleContent, "h1");
        /**
        * If there is only one h2, they are probably using it
        * as a header and not a subheader, so remove it since we already have a header.
        ***/
        if (articleContent.getElementsByTagName('h2').length == 1 && articleContent.getElementsByTagName('h2')[0].className != "oceanus-title")
            oceanus.clean(articleContent, "h2");
        ...
        sl_jQuery('p:first', articleContent).css('margin-top', '0');
    },
    ...
    grabArticles: function () {
        ...
        **/
        if (topCandidate == null || topCandidate.tagName == "BODY") {
            ...
            //            topCandidate.innerHTML = oceanus.documentCopy.innerHTML;
            //            oceanus.documentCopy.innerHTML = "";
            //            oceanus.documentCopy.appendChild(topCandidate);
            //            oceanus.initializeNode(topCandidate);
        }
