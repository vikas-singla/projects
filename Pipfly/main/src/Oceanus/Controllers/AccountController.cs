        ...
        public ActionResult SendInviteToFacebookUser(long friendFBUID)
        {
            ...
            if (userProfile != null)
            {
                ...
                bool querySuccessful = FacebookHelper.PostToFacebookWall(friendFBUID, fbToken, null, "I'd like you to join my network on Pipfly", domain,
                    friendFirstName + " - it's where you can find and share photos/videos/articles on topics you are passionate about.", null, "http://www.pipfly.com/images/sitetheme/Pipfly_logo_sm.png", null);
