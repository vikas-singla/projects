...
namespace JobCrawler.HTMLParser.HTMLElements
{
    ...
    internal abstract class HtmlEncoder
    {
        ...
        public static string DecodeValue( string value )
        {
            ...
            if (value == null)
            {
                return output.ToString(); //just return empty string
            }
                    ...
                    if ( c == ';' || c == ' ' )
                    {
                        ...
                        if ( token[ 1 ] == '#' )
                        {
                            ...
                            try
                            {
                                ...
                                {
                                    v = Int32.Parse(token.ToString().Substring(3, token.Length - 4), System.Globalization.NumberStyles.AllowHexSpecifier);
                                }
                                else //this is base 10 numeric reference!
                                {
                            ...
                            {
                                //someone didn't code the HTML right! We can't decode it and so ignore the formatting.
                            }                           
                        }
                        else
                        {
