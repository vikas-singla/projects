<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/RainForest.master"
    CodeBehind="Default.aspx.cs" Inherits="Rainforest.Pages.Career.Default" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="CphHTMLHeader">
    <link href="/Styles/CareerProgressionControlStyle.css" rel="stylesheet" type="text/css" />
    <link href="/Styles/CareerProgressionDetailsControlStyle.css" rel="stylesheet" type="text/css" />
    ...
    <link href="/Styles/SalaryDetailsControlStyle.css" rel="stylesheet" type="text/css" />
</asp:Content>
